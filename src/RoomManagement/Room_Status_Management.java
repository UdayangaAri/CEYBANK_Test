...
//			if (logs > 0) {
				...
				session1.setAttribute("StatusSucceedMessage", "StatusSucceedMessage");
	            response.sendRedirect("Room_Status_Management.jsp");  
...
//			}
			...
			session1.setAttribute("StatusFailedMessage", "StatusFailedMessage");
            response.sendRedirect("Room_Status_Management.jsp"); 
		}
