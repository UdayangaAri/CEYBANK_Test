...
if (null != session.getAttribute("not_updated")) {
						%>

						<div class="alert alert-danger" role="alert">Sorry! You can't change this access. Please check again...</div>
          ...
          <h4 class="m-0 font-weight-bold text-primary">Edit the assigned pages</h4>
					<form method="POST" class="forms" action="editFunctionServlet">
						...
						for (RoleFunction e : list) {
							//System.out.println("******************************************");
							//System.out.println("id by role : "+roleid);
							//System.out.println("function id : " + e.getFunctionID());
							//System.out.println("******************************************");
						...
						<div class="row" style="float: right">
							...
							<input class="btn btn-primary" type="submit" style="float: left; margin-right: 250px;"
								value="Delete">
