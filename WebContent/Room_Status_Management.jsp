					...
					<div class="container mt-3 a">
						...
						<div class="card shadow mb-4">
							...
							<div class="card-body" style="left: 30%">
								...
								<%
									} else if (null != Status_Failed) {
								%>
								<div class="alert alert-danger" role="alert">Status Update
									Failed..</div>
									...
									<div class="row">
										...
										<div class="col-25">
											...
											<%
												...
												//System.out.println("request.getParameter ::: " + request.getParameter("room_names"));
											%>

										</div>
										<div>
											<input type="hidden" name="id" id="id"
												value="<%=RoomStatusid%>" onchange="myFunction()"> <input
