						...
						<div class="container mt-5 a">
							...
							<div class="card shadow mb-4">
								...
								<div class="card-header py-3">
									...
									<%
										if (null != request.getAttribute("NUsucceed")) {
									%>
									<div class="alert alert-success" role="alert">Saved
										Successfully..</div>

									<%
										} else if (null != request.getAttribute("NUFailed")) {
									%>
								...
								<div class="card-body" style="left: 30%">
									...
									<form class="forms" action="NewsInsert" method="post">
										...
										<div>
											...
											<textarea name="newsDescription" id="newsDescription"
												rows="10" cols="30" placeholder="Update news"></textarea>
									...
									<form class="forms" action="NewsImage" method="post" enctype="multipart/form-data">

										<input type='file' name="photo" accept="image/*" onchange="readURL(this);" />
										<br> <img id="blah" src="#" alt="" /> <br> <br>
