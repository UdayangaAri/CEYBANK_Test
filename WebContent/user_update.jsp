						...
						<div class="row">
							...
							<div class="col-75">
								<input type="text" name="uname" readonly
									...
									data-content="You cannot change the username..">
							</div>
						</div>
						...
						<div class="row">
							...
							%>
								...
								<select name="role">
									...
									<option <%if (z.getRole().equals(resultset.getString(2))){ %>selected <%} %>> 
...
<%
									...
									<option <%if (b.getDisplayName().equals(rs.getString(3))){ %>selected <%} %>>
						...
						<div class="row">
							...
							<div class="col-75">
								...
								<input type="text" name="current_status" readonly value="Active">
								<%
									}
								%>
								...
								<div class="modal fade" id="exampleModal" tabindex="-1"
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												If you deactivate
												<%=e.getFirstName()%>, he will not be able to login to the
												system.
											</div>
											<div class="modal-footer">
												<button type="button" class="btn btn-secondary"
