	...
	<ul class="list-unstyled components">
		...
		<li><a href="#pageSubmenu4"
			...
			data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
				<img src="images/reserve.png" alt="" border=3 height=27 width=27
			...
			<ul class="collapse list-unstyled" id="pageSubmenu4">
				...
				<%
					for (RoleFunction e : list) {
						...
						if (i == 3) {
				%>
				<li><a href="" data-toggle="modal" data-target="#InsertUser"
					style="color: #fafafa; background-color: transparent;"> Add New
						Guest </a></li>
				<%
					}
					}
			...
			<ul class="collapse list-unstyled" id="pageSubmenu">
				...
				<%
					for (RoleFunction e : list) {
						...
						if (i == 15) {
				%>
				<li><a href="RoomRatesManagement.jsp"
					style="color: #fafafa; background-color: transparent;"> Room
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
	id="InsertUser" aria-labelledby="myLargeModalLabel" aria-hidden="true">
						...
						<div class="col-65">
							<div style="float: left;">
								...
								<label onclick="javascript:yesnoCheck();"> <input
									...
									type="radio" name="options" id="yesChecka" checked
